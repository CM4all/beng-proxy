...
IsAllowedWidgetHeader(std::string_view name) noexcept
{
	...
	/* refuse to set headers in our own namespace, because those
	   are generated by us and the widget server is supposed to be
	   able to trust them (e.g. "x-cm4all-beng-user") */
