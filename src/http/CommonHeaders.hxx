...
constexpr StringMapKey cookie2_header{"cookie2"};
...
constexpr StringMapKey x_cm4all_beng_peer_subject_header{"x-cm4all-beng-peer-subject"};
constexpr StringMapKey x_cm4all_beng_peer_issuer_subject_header{"x-cm4all-beng-peer-issuer-subject"};
constexpr StringMapKey x_cm4all_view_header{"x-cm4all-view"};
constexpr StringMapKey x_cm4all_widget_id_header{"x-cm4all-widget-id"};
