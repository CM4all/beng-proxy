...
trailing slashes are necessary.
...
\verb|USER_NAMESPACE| & Create the child process in a new user
namespace. \\

\hline

\verb|NETWORK_NAMESPACE| & Create the child process in a new network
namespace.  This prevents the process from doing network I/O, because
the new namespace has no network devices. \\
