...
exception: if \verb|PROCESS| is enabled and a widget is focused, the
...
link to a different host name (provided by the \verb|DOMAIN|
translation packet) \\
...
translation server enables it with the packet \verb|PROCESS\_CSS|.
