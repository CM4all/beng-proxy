...
Even when the browser does not support cookies, a widget may use them.
\emph{beng-proxy} will take care of session tracking.  Cookies may not
be set or read with JavaScript.
...
\begin{verbatim*}
<c:embed id="foo" href="http://cfatest01.intern.cm-ag/date.py" />
\end{verbatim*}
...
\hline
href & use an unregistered widget \\
\hline
...
\hline
iframe & embed the widget in an HTML IFRAME \\
\hline
