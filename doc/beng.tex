...
\verb|SECURE_VIEW| & Mark the current (named) view as ``secure''.
That means that it is inaccessible to clients, it can only be selected
in the template or by the widget response header
\texttt{X-CM4all-View}. \\
