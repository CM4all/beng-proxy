...
is an echo if the \verb|FILE_NOT_FOUND| from the previous translation
response. \\
...
translation server is asked to provide an alterate translation.  This
is an echo if the \verb|DIRECTORY_INDEX| from the previous translation
response. \\
...
\verb|FILE_NOT_FOUND|, \verb|DIRECTORY_INDEX|. \\
