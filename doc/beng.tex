...
prints the modified resource on stdout.  This is a simple alternative
to CGI: you don't get any request headers, and you cannot specify a
status or response headers.  The original headers are forwarded
as-is. \\
