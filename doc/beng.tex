...
the child process.  Payload is an array of 32 bit integers.  The
default is to run child processes with the same unprivileged
credentials as \emph{beng-proxy} itself.
