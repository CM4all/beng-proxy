...
test/t-wembed: test/t-wembed.o src/wembed.o src/pool.o src/pstring.o src/widget-stream.o src/istream-delayed.o src/istream-hold.o src/istream-forward.o src/istream-null.o src/uri-parser.o src/uri-escape.o src/format.o src/global.o
	$(CC) -o $@ $^ $(LDFLAGS) $(LIBDAEMON_LIBS)
