...
test/t-http-client: test/t-http-client.o src/http-client.o src/pool.o src/pstring.o src/strmap.o src/hashmap.o src/growing-buffer.o src/fifo-buffer.o src/header-writer.o src/istream-forward.o src/istream-string.o src/istream-memory.o src/istream-cat.o src/istream-fail.o src/http-body.o src/header-parser.o src/istream-chunked.o src/istream-dechunk.o src/format.o src/http.o src/strutil.o src/buffered-io.o src/fd-util.o src/socket-util.o src/istream-head.o src/istream-zero.o src/tpool.o
	$(CC) -o $@ $^ $(LDFLAGS) $(LIBEVENT_LIBS) $(LIBDAEMON_LIBS)
...
FILTER_TEST_CLASSES = cat chunked dechunk pipe hold delayed subst deflate byte iconv replace replace2 html-escape
...
test/t-wembed: test/t-wembed.o src/wembed.o src/pool.o src/pstring.o src/widget-stream.o src/istream-delayed.o src/istream-hold.o src/istream-forward.o src/uri-parser.o src/uri-escape.o src/format.o src/global.o
	$(CC) -o $@ $^ $(LDFLAGS) $(LIBDAEMON_LIBS)
