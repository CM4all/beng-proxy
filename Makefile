...
test/run-cookie-client: test/run-cookie-client.o src/cookie.o src/http-string.o src/header-writer.o src/growing-buffer.o src/pool.o src/pstring.o src/strmap.o
	$(CC) -o $@ $^ $(LDFLAGS) $(LIBDAEMON_LIBS)
